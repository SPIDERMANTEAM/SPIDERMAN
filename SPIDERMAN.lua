...
sudo_users = {SUDO,414452598,414452598}   
...
if tonumber(user_id) == tonumber(414452598) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1557972423) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."HH6HHH:Sudo", user_id) then 
...
{'المشتركين ✫','الكروبات ✫','اذاعه بالتثبيت ✫'},
{'ضع كليشه ستارت ✫','حذف كليشه ستارت ✫'},
{'اذاعه ✫','اذاعه خاص ✫'},
{'اذاعه بالتوجيه✫','قائمه الكتم العام ✫'},
...
send(msg.chat_id_, msg.id_,' ✫∫ تم تحديث السورس \n ✫∫ لديك اخر اصدار لسورس سبايدر\n ✫∫ الاصدار » { 1.3v}')
dofile('SPIDERMAN.lua')  
end
if text == 'الاصدار ✫' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ اصدار سورس سبايدر \n ✫∫ الاصدار »{ 1.3v}')
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ 𝚂𝙿𝙸𝙳𝙴𝚁\n\n[-  𝚂𝙿𝙸𝙳𝙴𝚁 ᴄʜᴀɴɴᴇʟ . ](t.me/JJU6UU)\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](t.me/JJJ6UU)\n[-  𝚂𝙿𝙸𝙳𝙴𝚁 ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](t.me/HH0HH_511)\n[-  ʙᴏᴛ 𝚂𝙿𝙸𝙳𝙴𝚁 .](t.me/Abvzxbot )"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝗪𝗘𝗟𝗖𝗢𝗺𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗥 𝗦𝗣𝗜𝗗𝗘𝗥.',url="t.me/JJJ6UU"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JJU6UU&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
...
if link then                              
send(msg.chat_id_,msg.id_,': group :\n••━━━━━━━━━━••\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبايدر').." غادر" or text == 'غادر' then  
...
data,res = https.request('https://zhsoaliz.ml/yahya/3nmoe/as.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ْ𝗦ِ𝗣َ𝗜ِD𝗘ً𝗥 َ𝗧ْ𝗘ِ𝗮ِ𝗺',url="t.me/JJU6UU"}},
}
local msg_id = msg.id_/2097152/0.5
...
*✫م10 ◂ اوامر الاعضاء*
••━━━━━━━━━━••
[ْ𝗦ِ𝗣َ𝗜ِD𝗘ً𝗥 َ𝗧ْ𝗘ِ𝗮ِ𝗺](t.me/JJU6UU) 
]]
