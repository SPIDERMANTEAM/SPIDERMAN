...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SPIDERMANTEAM/Files_SPIDERMAN/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1667656763,1336280373}   
...
if tonumber(user_id) == tonumber(1667656763) then  
var = true  
elseif tonumber(user_id) == tonumber(1336280373) then
var = true 
...
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1667656763) then
var = 'مبرمج سبايدر مان'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
...
os.execute('wget https://raw.http://github.com/Spyder/SPIDERMAN/master/SPIDERMAN.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سبايدر مان\n ❃∫ الاصدار » { 1.3v}')
dofile('SPIDERMAN.lua')  
end
if text == 'الاصدار ❃' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس سبايدر مان \n ❃∫ الاصدار »{ 1.3v}')
end
...
os.execute('rm -rf SPIDERMAN.lua')
os.execute('wget https://raw.githubusercontent.com/SPIDERMANTEAM/SPIDERMAN/master/SPIDERMAN.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سبايدر مان\n ❃∫ الاصدار » { 1.3v}')
dofile('SPIDERMAN.lua')  
end
...
⋄ ︙︙𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 S𝙿𝚈𝙳𝙴𝚁 ⁦ ⁦
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[S𝙿𝚈𝙳𝙴𝚁 ⁦𝘵𝘦𝘢𝘮](t.me/JJU6UU)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[D𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](t.me/lll_lll4)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⋄︙[B𝘰𝘵 C𝘰𝘯𝘯𝘦𝘤𝘵](t.me/VVV3VBOT)
└─────── SM ───────┘
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SPIDERMANTEAM/Files_SPIDERMAN/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات سبايدر مان\n ❃∫ ملفات السورس ↓\n≪━━━━━━SM━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━SM━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس سبايدر مان ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/pvv_v) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SPIDERMANTEAM/Files_SPIDERMAN/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SPIDERMAN.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس سبايدر مان \n") 
end
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سبايدر مان').." غادر" or text == 'غادر' then  
...
zh = https.request('https://rudi-dev.tk/Amir1/SPIDERMAN.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━SM━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━SM━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/pvv_v)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/SPIDERMAN.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/SPIDERMAN.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
